...
QT_MOC_LITERAL(6, 50, 5), // "Write"
QT_MOC_LITERAL(7, 56, 5) // "bytes"
...
struct qt_meta_stringdata_TaskFrequency_t {
    QByteArrayData data[3];
    char stringdata0[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TaskFrequency_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TaskFrequency_t qt_meta_stringdata_TaskFrequency = {
    {
QT_MOC_LITERAL(0, 0, 13), // "TaskFrequency"
QT_MOC_LITERAL(1, 14, 4), // "Read"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "TaskFrequency\0Read\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_TaskFrequency[] = {
...
void TaskFrequency::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TaskFrequency *_t = static_cast<TaskFrequency *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Read(); break;
        default: ;
...
const QMetaObject TaskFrequency::staticMetaObject = {
    { &SynFrequency::staticMetaObject, qt_meta_stringdata_TaskFrequency.data,
      qt_meta_data_TaskFrequency,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *TaskFrequency::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *TaskFrequency::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_TaskFrequency.stringdata0))
        return static_cast<void*>(const_cast< TaskFrequency*>(this));
    return SynFrequency::qt_metacast(_clname);
}

int TaskFrequency::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = SynFrequency::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
